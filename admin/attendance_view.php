        ...
        ?>
                        <div id="content-wrapper">
                            ...
                            ?>
                                          ...
                                          <button type="submit" name="view_attendance" class = "btn btn-yes">View Attendance</button>
                                           
 									
                                           </form>	
                                           	<br>
                                           <form action="view_defaulter.php" method ="post">
                                           	<button type="submit" name="view_defaulter" class = "btn btn-primary"> Normal Defaulter</button>
                             
                                           </form>
                                           <br>
                                           <form>
                                           	<button type="submit" name="view_critical" class = "btn btn-danger">Critical Defaulter</button>
                                           </form>									
                                            </div>
                                            </div>
